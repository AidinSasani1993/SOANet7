    ...
    public partial class init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    PersonRef = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Customer_Person_PersonRef",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_ProductCategories_CategoryRef",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ColleagueDiscounts_Products_ProductId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_CustomerDiscounts_Products_ProductId",
                        column: x => x.ProductId,
                        principalSchema: "Production",
                        principalTable: "Products",
                        principalColumn: "Id",
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    OrderRef = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CustomerTicket", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CustomerTicket_Orders_OrderId",
                        column: x => x.OrderId,
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    InventoryRef = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    ...
                    Description = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    OrderRef = table.Column<long>(type: "bigint", nullable: false),
                    OrderId = table.Column<Guid>(type: "uniqueidentifier", nullable: false)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InventoryOperation_Orders_OrderId",
                        column: x => x.OrderId,
                        principalTable: "Orders",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ColleagueDiscounts_ProductId",
                table: "ColleagueDiscounts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_Customer_PersonRef",
                schema: "Person",
                table: "Customer",
                column: "PersonRef");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerDiscounts_ProductId",
                table: "CustomerDiscounts",
                column: "ProductId");

            migrationBuilder.CreateIndex(
                name: "IX_CustomerTicket_OrderId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InventoryOperation_OrderId",
                table: "InventoryOperation",
                column: "OrderId");
